...
public class PaymentBankTransferTest {
    ...
    void testCreatePaymentBankSuccess(){
        ...
        Payment payment1 = new PaymentBankTransfer("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa",orders.get(0), "BANK", paymentDataBank);
    ...
    void testCreatePaymentFailBankName(){
        ...
        paymentDataBank.put("referenceCode", "0");
        assertThrows(IllegalArgumentException.class, ()-> {new PaymentBankTransfer("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa",orders.get(1),
